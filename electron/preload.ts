...
contextBridge.exposeInMainWorld('api', {
  ...
  listQuarantine: (roots: string[]) => ipcRenderer.invoke('quarantine:list', roots),
  restoreQuarantine: (roots: string[], paths: string[]) => ipcRenderer.invoke('quarantine:restore', roots, paths),
  deleteQuarantine: (roots: string[], paths: string[]) => ipcRenderer.invoke('quarantine:delete', roots, paths),
